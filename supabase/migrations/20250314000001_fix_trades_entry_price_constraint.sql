-- Update the process_expired_trades function to include entry_price when inserting into trades table
...
BEGIN
  ...
  LOOP
    ...
    INSERT INTO trades (
      user_id, crypto_pair, trade_type, amount, profit_loss, status, created_at, closed_at, entry_price
    ) VALUES (
      ...
      NOW(),
      COALESCE(trade_record.entry_price, 0) -- Use entry_price from trading_history or default to 0
    );
